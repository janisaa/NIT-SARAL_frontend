      ...
      <div className='signup-box'> 
        ...
        <div className='signup-right'>
          ...
          <form onSubmit={submitHandler} className='form'>
            ...
            <input required onChange ={e=>{setFullName(e.target.value)}}type = 'text' placeholder='Name'/>
            <input required onChange ={e=>{setScholarID(e.target.value)}}type = 'text' placeholder='Scholar ID'/>
